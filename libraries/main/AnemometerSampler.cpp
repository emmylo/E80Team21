#include "AnemometerSampler.h"
#include "Printer.h"

extern Printer printer;

AnemometerSampler::AnemometerSampler(void) 
  : DataSource("Button","bool") // from DataSource  HELP??
{}


void AnemometerSampler::init(void)
{
...
void AnemometerSampler::updateState(void)
...
String AnemometerSampler::printState(void)
...
size_t AnemometerSampler::writeDataBytes(unsigned char * buffer, size_t idx)
